...
%\usepackage[utf8]{inputenc} %in alternativa si può usare utf8
...
\usepackage{lscape} %modalità landscape
...
\begin{titlepage}                       %crea un ambiente libero da vincoli
                                        ...
                                        %   si può modificare quello che si
...
numerata, ma è solo scritta in grassetto.
...
bibliografia: questo è il mio riferimento \cite{K3,K4}.
